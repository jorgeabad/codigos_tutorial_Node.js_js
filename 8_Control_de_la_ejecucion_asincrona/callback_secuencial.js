"use strict";
const request = require("request"); //oresjeto realizar peticiones http GET
let listado = "\n Películas título/fecha:\n"; //Cadena para almacenar información
const url_base = "http://swapi.co/api/films/"; //url resase petición
...
let id = 1;
peticionAsincrona(id, function(err, res) {
  finRespuesta(err, res);
  id = 2;
  peticionAsincrona(id, function(err, res) {
    finRespuesta(err, res);
    id = 3;
